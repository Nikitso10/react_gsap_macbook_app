...
Files: macbook-16.glb [639.28KB] > C:\Users\nikim\MyFiles\react_macbook_gsap_app\public\models\macbook-16-transformed.glb [629.72KB] (1%)
  ...
  const { nodes, materials, scene } = useGLTF('/models/macbook-16-transformed.glb')
    ...
    useEffect(() => {
        scene.traverse((child) => {
            if(child.isMesh) {
                //change color if the part name is NOT in noChangeParts
